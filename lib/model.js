...
var DEFAULT_URL = 'https://licensing.blackpear.com/mdmconfig/api';
var LOGINROUTE = '/users/?login=';
var AUTHORISATIONROUTE = '/serviceroledefinitions?servicetype={{service_pyrusapps}}&usersid=';
var ORGANISATIONROUTE = '/clients/';
var PYRUSAPPS = 'ccca0960-bd91-4702-c19d-1dd8f939750c';
...
module.exports = function (options) {
    ...
    return function (req, res, next) {
        ...
        function authenticate(credentials) {
            var loginurl = options.url + LOGINROUTE + credentials.name;
            return request
                .get(loginurl)
        ...
        function authorise(user) {
            var authorisationurl = options.url + AUTHORISATIONROUTE + user.id;
            return request
        ...
        function organise() {
            var organisationurl = options.url + ORGANISATIONROUTE + req.authorisation.clientId;
            return request
                .get(organisationurl)
                .set('Authorization', req.headers.authorization)
                .promise();
